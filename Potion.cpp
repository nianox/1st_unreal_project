...
public:
    ...
    PotionRecipe searchPotionByName(const std::string& name)
    {
...
int main() {
    ...
    while (true) {
        ...
        if (choice == 1) {
            ...
            std::cout << "포션 이름으로 검색하기: " << std::endl;
            std::string name;
            std::cin >> name;
            myWorkshop.searchPotionByName(name);
            }
        else if (choice == 3) {
            std::cout << "포션 재료로 검색하기: " << std::endl;
            std::string ingredients;
            std::cin >> ingredients;
            myWorkshop.searchByIngredient(ingredients);
        }
        else if (choice == 5) {
